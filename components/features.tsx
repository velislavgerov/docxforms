    ...
    <div className="container border-top">
      <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <div className="feature col">
          ...
          <p>When a user fills out and submits a <strong>Form</strong> a <strong>Submission</strong> is created. <strong>Submissions</strong> store relevant information such as the time of submission, form data, submitter user name and email, and the resulting file.</p>
